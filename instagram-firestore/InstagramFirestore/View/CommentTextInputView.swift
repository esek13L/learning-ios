...
//  InstagramFirestore
//
//  Created by Esekiel Surbakti on 22/05/21.
//

import UIKit

protocol CommentTextInputViewDelegate: class {
    func inputView(_ view: CommentTextInputView, uploadComment: String)
}

class CommentTextInputView: UIView {
    
    //MARK: - Properties
    
    weak var delegate: CommentTextInputViewDelegate?
