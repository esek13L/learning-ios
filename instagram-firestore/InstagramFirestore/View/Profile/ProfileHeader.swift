...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var editProfileFollowButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(pressEditProfileFollow), for: .touchUpInside)
    ...
    private lazy var  followerLabel: UILabel = {
        ...
        label.numberOfLines = 0
        label.textAlignment = .center
        label.attributedText = attributedStatText(value: 4, label: "followers")
        return label
    }()
    ...
    @objc func pressEditProfileFollow(){
