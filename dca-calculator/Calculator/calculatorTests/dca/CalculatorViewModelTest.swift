...
class CalculatorViewModelTest: XCTestCase {
    ...
    private func buildWinningAsset() -> Asset {
        ...
        let meta = buildMeta()
        let timeSeries: [String : OHLC] = ["2021-01-25" : OHLC(open: "100", close: "110", adjustedClosed: "110"),
                                           "2021-02-25" : OHLC(open: "110", close: "120", adjustedClosed: "120"),
                                           "2021-03-25" : OHLC(open: "120", close: "130", adjustedClosed: "130"),
                                           "2021-04-25" : OHLC(open: "130", close: "140", adjustedClosed: "140"),
                                           "2021-05-25" : OHLC(open: "140", close: "150", adjustedClosed: "150"),
                                           "2021-06-25" : OHLC(open: "150", close: "160", adjustedClosed: "160")]
        let timeSeriesMonthlyAdjusted = MonthlyAdjusted(meta: meta,
    ...
    private func buildLosingAsset() -> Asset {
        let searchResult = buildSearchResult()
        let meta = buildMeta()
        let timeSeries: [String : OHLC] = ["2021-01-25" : OHLC(open: "170", close: "160", adjustedClosed: "160"),
                                           "2021-02-25" : OHLC(open: "160", close: "150", adjustedClosed: "150"),
                                           "2021-03-25" : OHLC(open: "150", close: "140", adjustedClosed: "140"),
                                           "2021-04-25" : OHLC(open: "140", close: "130", adjustedClosed: "130"),
                                           "2021-05-25" : OHLC(open: "130", close: "120", adjustedClosed: "120"),
                                           "2021-06-25" : OHLC(open: "120", close: "110", adjustedClosed: "110")]
        let timeSeriesMonthlyAdjusted = MonthlyAdjusted(meta: meta,
                                                                  timeSeries: timeSeries)
        return Asset(searchResult: searchResult,
                     monthlyAdjusted: timeSeriesMonthlyAdjusted)
